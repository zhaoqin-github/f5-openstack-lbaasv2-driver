...
AGENT_LOC=git+https://github.com/richbrowne/f5-openstack-agent.git@${BRANCH}
DRIVER_LOC=${DRIVER_PIP_INSTALL_LOCATION}
NEUTRON_DRIVER_LOC=https://raw.githubusercontent.com/F5Networks/neutron-lbaas/stable/mitaka/neutron_lbaas/drivers/f5/driver_v2.py
